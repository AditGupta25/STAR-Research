 ...
 * @author adit
 */
public class MenuDefCateg extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        CategTextArea = new javax.swing.JTextArea();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        getContentPane().setLayout(null);

        BackToHome2.setText("Back");
        BackToHome2.addActionListener(new java.awt.event.ActionListener() {
    ...
    private void BackToHome2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BackToHome2ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuDefCateg.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuDefCateg().setVisible(true);
            }
        });
    }
    ...
    private static javax.swing.JTextArea CategTextArea;
