 ...
 * @author adit
 */
public class MenuDefAct extends javax.swing.JFrame {
    ...
    private void BackToMain1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BackToMain1ActionPerformed
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuDefAct.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuDefAct().setVisible(true);
            }
        });
    }
